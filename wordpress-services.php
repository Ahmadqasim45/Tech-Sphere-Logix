...
<nav class="navbar navbar-expand-lg ftco_navbar ftco-navbar-light" id="ftco-navbar">
	...
	<section class="hero-wrap hero-wrap-2" id="hero-container-other" >
		...
		<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a>
			<span class="mr-2"><a href="services.php">Services <i class="fa fa-chevron-right"></i></a></span> <span>Wordpress <i class="fa fa-chevron-right"></i></span></p>
		<h1 class="mb-0 bread">Wordpress Services</h1>
		</div>
		</div>
		</div>
		</section>
	...
	<!-- particles section -->
					...
					<!--  services section-->
						...
						<div class="container">
							<span class="portfolio-category text-center" >Wordpress</span>
					<h2 class="mb-3 heading-title text-center" id="services-h">Wordpress Services</h2>
						<div class="row d-flex" style="margin-top: 20px;">
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/wordpress-blog-themes-2.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Wordpress Blog Design Integraion</h3>
						<p>
							We provide integrating custom WordPress blog designs that enhance user experience, boost engagement, and reflect your brand's unique identity.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/plugin-word.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Wordpress Plugin Development</h3>
						<p>We provide designing captivating labels that enhance product appeal, communicate brand values, and stand out on shelves effectively.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/Custom-WordPress-Development_-A-Comprehensive-Guide.png');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Wordpress Custom Development</h3>
						<p>We provide developing custom WordPress solutions tailored to your needs, ensuring functionality, scalability, and a unique brand presence.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/psdtow.jpeg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">PSD To WordPress</h3>
						<p>We provide converting PSD designs to WordPress, ensuring pixel-perfect accuracy, responsive layouts, and seamless functionality for your website.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/sitemaintenance.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Wordpress Website Maintainance</h3>
						<p>We provide comprehensive WordPress website maintenance, ensuring security, updates, backups, and optimal performance for your site.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/porto.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Wordpress E-Commerce Site</h3>
						<p>
							We provide developing custom WordPress eCommerce websites, ensuring seamless shopping experiences, secure transactions, and scalable online stores.</p>
						...
						<div class="col-lg-4 ftco-animate">
							<div class="blog-entry">
							<div  class="block-20" style="background-image: url('images/wordpress-security-checklist_fb2b985dee.png');">
							</div>
							<div class="text d-block text-center">
							
							<h3 class="heading">Wordpress Security And Backup</h3>
							<p>We provide robust WordPress security and backup services, protecting your site from threats and ensuring data integrity and availability.<p>
						...
						<div class="col-lg-4 ftco-animate">
							<div class="blog-entry">
							<div href="blog-single.html" class="block-20" style="background-image: url('images/How-to-update-wordpress-1.webp');">
							</div>
							<div class="text d-block text-center">
							
							<h3 class="heading">WordPress Content Updating</h3>
							<p>We provide regular WordPress content updates, ensuring your site stays current, engaging, and accurately reflects your latest offerings.</p>
						...
						<div class="col-lg-4 ftco-animate">
							<div class="blog-entry">
							<div href="blog-single.html" class="block-20" style="background-image: url('images/seo-word.png');">
							</div>
							<div class="text d-block text-center">
							
							<h3 class="heading">Wordpress SEO Freindly Site</h3>
							<p>We provide developing SEO-friendly WordPress websites, optimizing for search engines, enhancing visibility, and driving organic traffic to your site.</p>
