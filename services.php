...
<head>
	<title>Services - Tech Sphere Logix</title>
	<meta charset="utf-8">
  ...
  <div class="container">
    <div class="row justify-content-center pb-5">
      <div class="col-md-12 heading-section text-center ftco-animate">
        ...
        <h2 class="mb-4">Core Services - Move from Accuracy to Precision</h2>
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-md-4 d-flex align-self-stretch ftco-animate">
        <div class="services">
          <div class="icon"><span class="flaticon-good-review"></span></div>
          <!-- Web Development Card -->
          <div class="media-body">
            <a href="web1-services.php">
              <h3 class="heading mb-3">Web Development</h3>
              <p>We offer top-notch web development services tailored to meet your business needs. Our expert team
                ensures
                your website is robust, scalable, and user-friendly.</p>
            </a>
          </div>
          <a href="web1-services.php"
        ...
        <div class="services">
          ...
          <div class="media-body">
            <a href="app-services.php">
              ...
              <p>Our app development services cover both Android and iOS platforms. We create high-performance apps with
                seamless user experiences to engage your audience effectively.</p>
            </a>
          </div>
          <a href="app-services.php" class="btn-custom d-flex align-items-center justify-content-center"><span
              class="fa fa-chevron-right"></span></a>
        </div>
      </div></a>
      <div class="col-md-4 d-flex align-self-stretch ftco-animate">
        <div class="services">
          ...
          <div class="media-body">
            <a href="UXUI.php">
              ...
              <p>Our UI/UX design services focus on creating intuitive and engaging interfaces. We ensure your users
                have
                a seamless and enjoyable experience on your website or app.</p>
            </a>
          </div>
          <a href="UXUI.php" class="btn-custom d-flex align-items-center justify-content-center"><span
              class="fa fa-chevron-right"></span></a>
        </div>
      </div>
      <div class="col-md-4 d-flex align-self-stretch ftco-animate">
        <div class="services">
          <div class="icon"><span class="flaticon-waiter"></span></div>
          <!-- Graphic Design Card -->
          <div class="media-body">
            <a href="graphic-services.php">
              <h3 class="heading mb-3">Graphic Design</h3>
              <p>Our graphic design services include branding, print design, and digital graphics. We create visually
                appealing designs that effectively communicate your brand message.</p>
            </a>
          </div>
          <a href="UXUI.php" class="btn-custom d-flex align-items-center justify-content-center"><span
              class="fa fa-chevron-right"></span></a>
        ...
        <div class="services">
          ...
          <div class="media-body">
            <a href="wordpress-services.php">
              <h3 class="heading mb-3">WordPress</h3>
              <p>We provide comprehensive WordPress services, including theme customization, plugin development, and
                site
                maintenance, ensuring your website is always up-to-date and secure.</p>
            </a>
          </div>
          <a href="wordpress-services.php"
            class="btn-custom d-flex align-items-center justify-content-center"><span
      ...
      <div class="col-md-4 d-flex align-self-stretch ftco-animate">
        <div class="services">
          <div class="icon"><span class="flaticon-conversation"></span></div>
          <!-- Shopify Card -->
          <div class="media-body">
            <a href="shopify-services.php">
              <h3 class="heading mb-3">Shopify</h3>
              <p>Our Shopify services include store setup, customization, and optimization. We help you create a
                powerful
                e-commerce platform to sell your products online effectively.</p>
            </a>
          </div>
          <a href="shopify-services.php"
            class="btn-custom d-flex align-items-center justify-content-center"><span
        ...
        <div class="services">
          ...
          <div class="media-body">
            <a href="webflow-services.php">
              <h3 class="heading mb-3">Web Flow</h3>
              <p>Leverage our expertise in Web Flow to build responsive and visually stunning websites. We ensure your
                site looks great on all devices and delivers an exceptional user experience.</p>
            </a>
          </div>
          <a href="webflow-services.php" class="btn-custom d-flex align-items-center justify-content-center"><span
              class="fa fa-chevron-right"></span></a>
        </div>
      </div>
      <div class="col-md-4 d-flex align-self-stretch ftco-animate">
        <div class="services">
          ...
          <div class="media-body">
            <a href="software-services.php">
              ...
              <p>We provide development services, crafting custom websites, apps, and software solutions that meet your unique business needs and drive growth.</p>
            </a>
          </div>
          <a href="software-services.php" class="btn-custom d-flex align-items-center justify-content-center"><span
              class="fa fa-chevron-right"></span></a>
        </div>
      </div>
        ...
        <div class="services">
          ...
          <div class="media-body">
            <a href="marketing-services.php">
              ...
              <p>We provide tailored digital marketing services, including SEO, PPC, social media, content, and email marketing, to boost your online presence.</p>
            </a>
          </div>
          <a href="marketing-services.php" class="btn-custom d-flex align-items-center justify-content-center"><span
              class="fa fa-chevron-right"></span></a>
        </div>
      </div>
       <!-- end Marketing -->
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816"
  ...
  data-cf-beacon='{"rayId":"7e37d8c66af385b4","version":"2023.4.0","b":1,"token":"cd0b4b3a733644fc843ef0b185f98241","si":100}'
