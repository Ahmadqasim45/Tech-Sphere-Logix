...
<html lang="en">
<head>
	<title>Shopify Solution - Tech Sphere Logix -Graphics Services</title>
	<meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg ftco_navbar ftco-navbar-light" id="ftco-navbar">
	...
	<section class="hero-wrap hero-wrap-2" id="hero-container-other" >
		...
		<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a>
			<span class="mr-2"><a href="services.php">Services <i class="fa fa-chevron-right"></i></a></span> <span>Shopify <i class="fa fa-chevron-right"></i></span></p>
		<h1 class="mb-0 bread">Shopify Services</h1>
		</div>
		</div>
		</div>
		</section>
	...
	<!-- particles section -->
					...
					<!--  services section-->
						...
						<div class="container">
							<span class="portfolio-category text-center" >Shopify</span>
					<h2 class="mb-3 heading-title text-center" id="services-h">Shopify Services</h2>
						<div class="row d-flex" style="margin-top: 20px;">
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/Dawn_-_Blog_img_-_Cover_-_UPDATED_aug26.webp');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Wordpress Blog Design Integraion</h3>
						<p>
							
                        We provide custom Shopify theme development, creating visually appealing, user-friendly designs that enhance your online store's functionality and branding.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/product-management.png');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Shopify Product Management</h3>
						<p>We provide Shopify product management services, ensuring efficient inventory handling, product updates, and enhanced customer shopping experiences.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/Shopify-Custom-App-Development-banner.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Shopify App Development</h3>
						<p>We provide Shopify app development services, creating customized solutions to extend functionality, optimize operations, and enhance customer interactions.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/Social-Media-Marketing-Tips-For-Shopify-Stores-In-2022.png');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Social Media Branding</h3>
						<p>We provide Shopify social media branding services, crafting cohesive strategies to amplify brand presence and engagement across platforms.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/blog-covers--39-.png');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Product Import And Maintainance</h3>
						<p>We provide Shopify product import and maintenance services, ensuring seamless updates and optimal management for your online store inventory.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/custom-shopify-theme-vs-modifying-pre-made-shopify-theme.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Theme Customization</h3>
						<p>
							We provide Shopify theme customization services, tailoring design elements to align with your brand, enhance functionality.</p>
						...
						<div class="col-lg-4 ftco-animate">
							<div class="blog-entry">
							<div  class="block-20" style="background-image: url('images/The-Complete-Guide-to-Shopify-Payments-1024x536.png');">
							</div>
							<div class="text d-block text-center">
							
							<h3 class="heading">Shopify Payment Gateway Integration</h3>
							<p>We provide Shopify payment gateway integration for secure and seamless online transactions and customer convenience.<p>
						...
						<div class="col-lg-4 ftco-animate">
							<div class="blog-entry">
							<div href="blog-single.html" class="block-20" style="background-image: url('images/Shopify-Speed-score-Optimization.jpg');">
							</div>
							<div class="text d-block text-center">
							
							<h3 class="heading">Shopify Speed Optimization</h3>
							<p>We provide Shopify speed optimization services, improving site performance for faster loading times and enhanced user experience.
                                                  </p>
						...
						<div class="col-lg-4 ftco-animate">
							<div class="blog-entry">
							<div href="blog-single.html" class="block-20" style="background-image: url('images/shopify-seo.png');">
							</div>
							<div class="text d-block text-center">
							
							<h3 class="heading">Shopify SEO</h3>
							<p>We provide Shopify SEO services, optimizing your store for higher search engine rankings, increased visibility, and improved online presence.</p>
