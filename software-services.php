...
<html lang="en">
<head>
	<title>Software Development Solutions - Tech Sphere Logix</title>
	<meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg ftco_navbar ftco-navbar-light" id="ftco-navbar">
	...
	<section class="hero-wrap hero-wrap-2" id="hero-container-other" >
		...
		<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a>
			<span class="mr-2"><a href="services.php">Services <i class="fa fa-chevron-right"></i></a></span> <span>Software Development <i class="fa fa-chevron-right"></i></span></p>
		<h1 class="mb-0 bread">Software Services</h1>
		</div>
		</div>
		</div>
		</section>
	...
	<!-- particles section -->
					...
					<!--  services section-->
						...
						<div class="container">
							<span class="portfolio-category text-center" >Sofware Development</span>
					<h2 class="mb-3 heading-title text-center" id="services-h">Sofware Development Services</h2>
						<div class="row d-flex" style="margin-top: 20px;">
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/Software-Maintenance.png');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Software Maintainance</h3>
						<p>We provide software maintenance services, ensuring your applications run smoothly with updates, bug fixes, and meet your requirements</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/software-imp.png');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Software Implementation</h3>
						<p>We provide software implementation services, seamlessly integrating tailored solutions to optimize your business operations and enhance efficiency.
						</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/Integration-testing@3x-e1635175453983.png');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Interaction And Testing</h3>
						<p>We provide crafting interactive designs for engaging user experiences, ensuring intuitive navigation, accessibility, and satisfaction.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/software-development-specialist.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Development</h3>
						<p>We provide software development services, creating scalable, custom solutions tailored to meet your business's specific needs and goals.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/design-software.webp');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Software Design</h3>
						<p>We provide software design services, crafting intuitive and user-centric interfaces that enhance usability and functionality..</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/Hardware_Software_Requirements.svg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Software Requirements</h3>
						<p>We provide software requirements services, meticulously gathering and analyzing your business needs to define clear and project specifications.</p>
