...
<body>
			...
			<div class="row no-gutters slider-text align-items-end" id="heading-hero">
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i
							...
							<span class="mr-2"><a href="services.php">Services <i
										class="fa fa-chevron-right"></i></a></span> <span>App Development <i
									class="fa fa-chevron-right"></i></span></p>
					<h1 class="mb-0 bread">App Services</h1>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="ftco-section bg-light">
		<div class="container">
			<span class="portfolio-category text-center">App Development</span>
			<h2 class="mb-3 heading-title text-center" id="services-h">App Services</h2>
			<div class="row d-flex" style="margin-top: 20px;">
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						<div href="blog-single.html" class="block-20"
							style="background-image: url('images/ios-app-half-banner.jpg');">
						</div>
						<div class="text d-block text-center">

							<h3 class="heading">iOS App Development</h3>
							<p>Crafting elegant, high-performance iOS apps to deliver seamless user experiences and
								significantly enhance your brand's presence.</p>
				...
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						<div href="blog-single.html" class="block-20"
							style="background-image: url('images/android-development-neetable.jpg');">
						</div>
						<div class="text d-block text-center">

							<h3 class="heading">Android App Development</h3>
							<p>Building powerful, scalable Android apps designed to maximize reach, ensuring high user
								engagement and satisfaction across devices
							</p>
				...
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						<div href="blog-single.html" class="block-20"
							style="background-image: url('images/maintainanc\ app.png');">
						</div>
						<div class="text d-block text-center">

							<h3 class="heading">App Maintenance and Support</h3>
							<p>Providing ongoing maintenance and support services to keep your app running smoothly,
								securely, and up-to-date, ensuring reliability</p>
				...
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						<div href="blog-single.html" class="block-20"
							style="background-image: url('images/custom-software-development.jpg');">
						</div>
						<div class="text d-block text-center">

							<h3 class="heading">Custom App Development</h3>
							<p>Tailoring unique app solutions specifically to meet your business needs, goals, and
								objectives, ensuring optimal performance and growth..</p>
				...
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						<div href="blog-single.html" class="block-20"
							style="background-image: url('images/eCommerce-App-Development.png');">
						</div>
						<div class="text d-block text-center">

							<h3 class="heading">E-Commerce App Development</h3>
							<p>Designing feature-rich e-commerce apps to boost online sales, enhance customer
								satisfaction, and streamline shopping experiences effectively.</p>
				...
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						<div href="blog-single.html" class="block-20"
							style="background-image: url('images/enterprise-application-development-1.webp');">
						</div>
						<div class="text d-block text-center">

							<h3 class="heading">Enterprise App Development</h3>
							<p>Creating robust enterprise apps that streamline business operations, enhance
								productivity, and support organizational growth.</p>
				...
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						<div class="block-20" style="background-image: url('images/apiapp.png');">
						</div>
						<div class="text d-block text-center">

							<h3 class="heading">API Integration</h3>
							<p>Transforming concepts into engaging user interfaces with modern frameworks and responsive
								design for seamless digital experiences on any device.
							<p>
				...
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						<div href="blog-single.html" class="block-20"
							style="background-image: url('images/What-is-back-end-development-2.jpg');">
						</div>
						<div class="text d-block text-center">

							<h3 class="heading">Backend Development</h3>
							<p>Building powerful server-side solutions for seamless data management, performance
								optimization, and scalable application architectures</p>
				...
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						<div href="blog-single.html" class="block-20"
							style="background-image: url('images/payment.jpg');">
						</div>
						<div class="text d-block text-center">

							<h3 class="heading">Payment Gateway</h3>
							<p>Secure and seamless payment gateway services, ensuring smooth transactions and boosting
								your business with reliable, easy integration.</p>
			...
			<div class="row">
				<div class="col-md-12" data-aos="fade-left">
					...
					<div class="form-container-custom">
						<h1 class="form-heading-custom">CONNECT <span class="form-heading-span-custom">WITH US</span>
						</h1>
						...
						<form class="contact-form-custom" action="form_handler.php" method="post">
							...
							<input type="text" name="name" class="form-input-custom" placeholder="Enter Your Name"
								required>
							<input type="email" name="email" class="form-input-custom" placeholder="Enter Your Email"
								required>
							<input type="text" name="phone" class="form-input-custom" placeholder="Enter Phone Number"
								required>
							<input type="text" name="city" class="form-input-custom" placeholder="City" required>
							<input type="text" name="business" class="form-input-custom"
