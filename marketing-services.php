...
<nav class="navbar navbar-expand-lg ftco_navbar ftco-navbar-light" id="ftco-navbar">
	...
	<section class="hero-wrap hero-wrap-2" id="hero-container-other" >
		...
		<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a>
			<span class="mr-2"><a href="services.php">Services <i class="fa fa-chevron-right"></i></a></span> <span>Digital Marketing<i class="fa fa-chevron-right"></i></span></p>
	...
	<!-- particles section -->
					...
					<h2 class="mb-3 heading-title text-center" id="services-h">Marketing Servies</h2>
						...
						<div href="blog-single.html" class="block-20" style="background-image: url('images/ads-marketing.jpeg');">
						</div>
                       ...
                       We provide expert Google AdWords management, optimizing your campaigns to maximize ROI, drive targeted traffic, and increase conversions efficiently.
</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/email-marketing.jpeg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Email Marketing</h3>
						<p>We provide personalized email marketing services, crafting targeted campaigns to engage your audience, boost conversions, and strengthen customer relationships</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/google-nalytics.avif');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Google Analytics</h3>
						<p>We provide Google Analytics services, offering insights into your website's performance to optimize strategies, improve user experience.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/website-marketing-764x400.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Website Marketing</h3>
						<p>We provide website marketing services, enhancing your online visibility through SEO, content creation, social media, and targeted campaigns to drive traffic.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/Affiliate-Marketin2.webp');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Affliate Marketing</h3>
						<p>We provide affiliate marketing services, connecting you with top affiliates to promote your products, increase sales, and expand your reach effectively.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/social-media.jpeg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Social Media Marketing</h3>
						<p>
							We provide social media marketing services, creating engaging content and strategies to boost your brand’s presence, attract followers, and drive conversions.</p>
