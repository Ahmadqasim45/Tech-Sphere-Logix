...
<html lang="en">
<head>
	<title>UX/UI Designin - Tech Sphere Logix</title>
	<meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg ftco_navbar ftco-navbar-light" id="ftco-navbar">
	...
	<section class="hero-wrap hero-wrap-2" id="hero-container-other" >
		...
		<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a>
			<span class="mr-2"><a href="services.php">Services <i class="fa fa-chevron-right"></i></a></span> <span>UI/UX Design <i class="fa fa-chevron-right"></i></span></p>
		<h1 class="mb-0 bread">UI/UX Services</h1>
		</div>
		</div>
		</div>
		</section>
	...
	<!-- particles section -->
					...
					<!--  services section-->
						...
						<div class="container">
							<span class="portfolio-category text-center" >UX/UI Design</span>
					<h2 class="mb-3 heading-title text-center" id="services-h">UX/UI Design Services</h2>
						<div class="row d-flex" style="margin-top: 20px;">
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/UX.UI-ui.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">User Interface Design</h3>
						<p>We provide crafting visually appealing interfaces for intuitive and seamless user interactions across digital platforms and applications.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/responsive-ui.jpg');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Responsive Design</h3>
						<p>We provide creating responsive designs for optimal user experiences across all devices, ensuring accessibility and usability.
						</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/interacion-ui.jpg');">
						</div>
						<div class="text d-block text-center">
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/guide-to-information-architecture.png');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Information Architecture</h3>
						<p>We provide creating structured information architecture to optimize user navigation, enhance content findability, and improve user experience.</p>
						...
						<div class="col-lg-4 ftco-animate">
						<div class="blog-entry">
						<div href="blog-single.html" class="block-20" style="background-image: url('images/thinking-ui.png');">
						</div>
						<div class="text d-block text-center">
						
						<h3 class="heading">Innovative Design Solutions</h3>
						<p>We provide crafting innovative designs that elevate user experiences, drive digital engagement, and enhance brand presence.</p>
						...
						<h3 class="heading">Interactive Experience Design</h3>
						<p>We provide crafting innovative designs that elevate user experiences, drive digital engagement, and enhance brand presence.</p>
