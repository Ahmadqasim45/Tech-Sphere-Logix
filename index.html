...
<!-- Mirrored from preview.colorlib.com/theme/portech/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Jul 2023 11:05:04 GMT -->

<!-- Mirrored from sireach.com/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2024 13:37:45 GMT -->
 <!-- favicon -->
					...
					<div class="row d-flex no-gutters slider-text js-fullheight align-items-center align-items-stretch">
						...
						<div class="col-md-6 ftco-animate d-flex align-items-center">
							<div class="text w-100">
								<span class="subheading">Welcome to Tech Sphere Logix</h2></span>
								<h1>We Create Website the Way You Want with Tech Sphere Logix</h1>
			...
			<div class="slider-item js-fullheight" style="background-image:url(images/bg_2.jpg);">
				...
				<div class="container">
					<div class="row d-flex no-gutters slider-text js-fullheight align-items-center align-items-stretch">
						...
						<div class="col-md-6 ftco-animate d-flex align-items-center">
							<div class="text w-100 mb-5">
								<span class="subheading">Creative Portfolio</h2></span>
								<h1>We Provide Effective for Business Solutions</h1>
								<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia
									and Consonantia, there live the blind texts.</p>
								<p><a href="#" class="btn btn-primary">Learn More</a> <a href="#"
										class="btn btn-white">View Portfolio</a></p>
			...
			<div class="row">
				...
				<div class="col-md-3 d-flex align-self-stretch ftco-animate">
					<div class="services">
						...
						<div class="media-body">
							<h3 class="heading mb-3">Search Optimization</h3>
							<p>A small river named Duden flows by their place and supplies it with the necessary
								regelialia. It is a paradisematic country, in which roasted parts of sentences fly into
								your mouth.</p>
						</div>
						...
						<div class="col-md-6 pl-md-5 py-5">
							<div class="row justify-content-start pb-3">
								<div class="col-md-12 heading-section ftco-animate">
									<span class="subheading">Welcome to Portech</span>
									<h2 class="mb-4">We Are Portech Creative Studio Agency</h2>
										...
										<div class="col-md-6 ftco-animate">
											<div class="services-2 d-flex align-items-center">
												<div class="icon d-flex align-items-center justify-content-center"><span
														class="flaticon-conversation"></span></div>
												<div class="media-body">
				...
				<div class="col-md-4 ftco-animate">
					<div class="project-wrap img d-flex align-items-end"
						...
						<div class="text">
							...
							<h3><a href="portfolio-single.html">Creative Design</a></h3>
		...
		<div class="container">
			...
			<div class="row" data-aos="fade-up">
				<div class="col-lg-12 d-flex justify-content-center">
					<ul id="portfolio-filters" class="d-flex flex-wrap list-unstyled">
						<li data-filter="*" class="filter-active">All</li>
						<li data-filter=".filter-app">App</li>
						<li data-filter=".filter-web">Web</li>
						<li data-filter=".filter-blog">Blog Sites</li>
						<li data-filter=".filter-app">Wordpress</li>
						<li data-filter=".filter-web">Shopify</li>
						<li data-filter=".filter-blog">Web Flow</li>
					</ul>
				</div>
			</div>
			<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
				<div class="col-lg-4 col-md-6 portfolio-item filter-web">
					<div class="portfolio-wrap">
						<img src="images\construction.png" class="img-fluid" alt="Site Thumbnail"
							style="height: 211px;">
						<div class="portfolio-hover">
							<h5>Site Name</h5>
							<a id="project-link"  href="https://www.pakebs.com/" target="_blank" rel="noopener noreferrer">Visit Site</a>
						</div>
					</div>
				</div>
				<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
					<div class="col-lg-4 col-md-6 portfolio-item filter-app">
						<div class="portfolio-wrap">
							<img src="images\discover.png" class="img-fluid" alt="Site Thumbnail"
								style="height: 211px;">
							<div class="portfolio-hover">
								<h5>Site Name</h5>
								<a id="project-link"  href="https://www.pakebs.com/" target="_blank" rel="noopener noreferrer">Visit Site</a>
					...
					<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
						<div class="col-lg-4 col-md-6 portfolio-item filter-web">
							<div class="portfolio-wrap">
								<img src="images\gym.png" class="img-fluid" alt="Site Thumbnail"
									style="height: 211px;">
								<div class="portfolio-hover">
									<h5>Site Name</h5>
									<a id="project-link"  href="https://www.pakebs.com/" target="_blank" rel="noopener noreferrer">Visit Site</a>
						...
						<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
							<div class="col-lg-4 col-md-6 portfolio-item filter-web">
								<div class="portfolio-wrap">
									<img src="images\idealtop.png" class="img-fluid" alt="Site Thumbnail"
										style="height: 211px;">
									<div class="portfolio-hover">
										<h5>Site Name</h5>
										<a href="https://www.pakebs.com/" target="_blank"
							...
							<ul>
								...
								<li><a href="#"><span class="icon fa fa-paper-plane pr-4"></span><span
											class="text"><span class="__cf_email__"
												data-cfemail="640d0a020b241d0b1116000b09050d0a4a070b09">[email&#160;protected]</span></span></a>
								</li>
							</ul>
						</div>
					</div>
...
<!-- Mirrored from sireach.com/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2024 13:38:38 GMT -->
